...
const Login = () => {
  ...
  useEffect(() => {
    ...
    function initParticles() {
      ...
      for (let i = 0; i < 80; i++) {
        ...
        let sx = (Math.random() - 0.5) * 0.4;
        let sy = (Math.random() - 0.5) * 0.3;
      ...
      for (let i = 0; i < 30; i++) {
        ...
        let x = Math.random() * width;
        let y = Math.random() * height;
        let sx = (Math.random() - 0.5) * 0.25;
        let sy = (Math.random() - 0.5) * 0.2;
  ...
  return (
    <>
        ...
        <div className="guard-wrapper">
          <div className="guard-character">
            ...
            <div className="bubble">
              <i className="fas fa-shield-alt"></i> Seguridad UTA activa
            </div>
        ...
        <div className="login-container">
          <div className="login-card">
            <div className="shield-header">
              ...
              <div className="sub">
                <i className="fas fa-university"></i> Universidad Tecnica de Ambato
              </div>
              <div className="security-tag">
                <i className="fas fa-lock"></i> Plataforma de Seguridad Institucional
              </div>
            </div>
      ...
      <div className="footer-uta">© 2025 UTA Seguridad - Protegiendo tu identidad digital</div>
    </>
  );
};
