...
const DATABASE_NAMES = {
  identidad: process.env.DB_IDENTIDAD_NAME || process.env.DB_NAME || 'BD_IDENTIDAD',
  incidentes: process.env.DB_INCIDENTES_NAME || 'BD_INCIDENTES',
  seguridad: process.env.DB_SEGURIDAD_NAME || 'BD_SEGURIDAD',
...
module.exports = {
  ...
  testConnections,
  query: (...args) => getDb('identidad').query(...args)
};
